...
def attach_labels(pipes: List[Pipe], texts: List[Dict], 
    ...
    node_elevations = [95.0, 94.5, 94.0]  # Mock node elevations
    constant_elevation = min(node_elevations) if node_elevations else 95.0
...
def detect_water_network(vectors: List[Dict], texts: List[Dict], 
    ...
    for p in pipes_with_depth:
        ...
        pipe_qa_flags = validate_pipe_qa(pipe_dict, "water")
